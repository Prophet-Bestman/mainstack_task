  ...
  return (
    <div className="grid grid-cols-1 grid-rows-2 min-h-screen bg-[#F2F5FA]">
      ...
      <div className="flex justify-center -mt-8 md:mt-0 items-center h-screen">
        <div className="flex flex-col col-span-1 items-center row-span-1 py-1 z-10 mx-6">
          <h1 className="font-bold max-w-[830px] text-3xl leading-8 md:leading-[67px] md:text-heroSize z-10 text-center">
            Create a one-page site to showcase your incredible works and{" "}
            <span className="text-brand-primary-900"> get more clients.</span>
          </h1>
          <p className="my-[32px] leading-[150%] text-brand-gray text-lg md:text-xl text-center max-w-[618px]">
            Mainstack connects your audience to all of your content,
            productivity with just one click to boost conversion rate.
          </p>

          <div className="flex z-10 px-2 flex-col lg:flex-row items-center justify-center">
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="h-12 sm:h-[74px] w-full sm:w-[341px]  bg-[#DDE3F0] rounded-full my-2 focus:outline-none  pl-40 md:pl-44 pr-[66px] mx-1.5 focus:ring-brand-primary-900 focus:ring-[3px]"
              />
              <img
                src="/img/check.png"
            ...
            <button className="px-[18px] py-[10px] sm:px-[32px] sm:py-[24px] bg-brand-primary-900 my-2 text-white w-full sm:w-[341px] sm:w-auto rounded-full mx-1.5 font-medium text-lg sm:text-2xl">
              Create your stack
            </button>
          </div>
        </div>
